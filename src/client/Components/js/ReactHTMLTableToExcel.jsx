...
class ReactHTMLTableToExcel extends Component {
  ...
  handleDownload() {
    ...
    if (document.getElementsByClassName(this.props.table)[0].nodeType !== 1 || document.getElementsByClassName(this.props.table)[0].nodeName !== 'TABLE') {
      if (process.env.NODE_ENV !== 'production') {
    ...
    const table = document.getElementsByClassName(this.props.table)[0].outerHTML.replace("<th>Actions</th>","").replace(new RegExp("View", 'g'),"");
